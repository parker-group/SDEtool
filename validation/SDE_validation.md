...
<img src="figures/Compare_1x_Ronly.png" alt="1× compare: ArcGIS vs CrimeStat vs Prob" width="720" />
  
**Figure A.** 1× SDE comparison. ArcGIS preset (blue), CrimeStat preset (red dashed), Probabilistic 68.27% (green dot-dash).

<img src="figures/Compare_2x_Ronly.png" alt="2× compare: ArcGIS vs CrimeStat vs Prob" width="720" />
